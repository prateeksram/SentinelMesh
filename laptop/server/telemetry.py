"""Telemetry aggregation (handoff §6, D3; handoff-2 P2).
...
sources are stale — dead ≠ idle, and the dashboard must show which.
"""
    ...
    def snapshot(self) -> dict:
        ...
        for key, entry in self._devices.items():
            ...
            for unit, sources in entry["units"].items():
                ...
                if best_age is None:      # ALL sources stale — surface the freshest
